...
i. ширина
ii. висота
b. додати публічний метод-член класу
i. для розрахунку площі

2. Створити - Точка
a. додати публічні змінні-члени класу:
i. x
ii. y
iii. z
...
Написати програму розрахунку вартості газу за рік:
...
Для цього в класі створити відповідні сетери і гетери.

4. Порахувати суму оплати помісячно та за рік по абоненту Іван Іванович
